# Contributing to can-is-browser-window

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/canjs/can-is-browser-window) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-is-browser-window, you can start by going to its [fork page](https://github.com/canjs/can-is-browser-window/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-is-browser-window
```
